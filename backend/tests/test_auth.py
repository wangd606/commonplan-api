...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("get", "/api/v1/workspaces/workspace-1/teams/team-1/projects", None),
        ("post", "/api/v1/workspaces/workspace-1/teams/team-1/projects", {"name": "Launch"}),
        ("get", "/api/v1/workspaces/workspace-1/teams/team-1/projects/project-1", None),
